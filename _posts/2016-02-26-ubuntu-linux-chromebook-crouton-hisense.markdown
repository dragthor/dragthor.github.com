...
In the future, I plan on purchasing two more [Chromebooks for my kids](http://amzn.to/21AnI8c) (wink wink - dad will be taking them apart).  Probably with an Intel processor just to see if I can successfully build an existing Android project.
