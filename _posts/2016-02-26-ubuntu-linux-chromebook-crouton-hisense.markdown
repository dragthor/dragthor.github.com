...
In the future I plan on purchasing two more Chromebooks for my kids.  Probably with an Intel processor just to see if I can build an existing Android project.
